...
@section('content')
    <div class="d-flex justify-content-between mb-3">
        <form action="{{ route('admin.admin.index') }}" class="d-flex gap-2" method="GET">
        ...
        @can('admin-create')
            <a href="{{ route('admin.admin.create') }}" class="btn btn-primary mb-2"><i class="bi bi-plus-lg"></i> Create Admin</a>
        @endcan
    </div>
                        ...
                        <td>
                            @php
                                $data = [
                                    [
                                        'type' => 'edit',
                                        'url' => route('admin.admin.edit', $item->id),
                                        'color' => 'btn-primary',
                                        'label' => '<i class="bi bi-pencil-square"></i>',
                                    ],
                                    [
                                        'type' => 'delete',
                                        'url' => route('admin.admin.delete', $item->id),
                                        'color' => 'btn-danger',
