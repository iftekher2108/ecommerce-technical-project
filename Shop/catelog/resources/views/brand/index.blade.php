...
@section('content')
    <div class="d-flex justify-content-between mb-3">
        ...
        @can('brand-create')
            <a href="{{ route('admin.brand.create') }}" class="btn btn-primary mb-2"><i class="bi bi-plus-lg"></i> Create Brand</a>
        @endcan
    </div>
                ...
                @foreach ($brands as $key => $item)
                    <tr class="align-middle">
                        ...
                        <td>
                            @php
                                $data = [
                                    [
                                     ...
                                     [
                                        'type' => 'status',
                                        'url' => route('admin.brand.status', $item->id),
                            ...
                            @endphp
                            <x-admin::action-btn title='brand' :data="$data" />
                        </td>
                    </tr>
                @endforeach
