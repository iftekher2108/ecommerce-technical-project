...
<div class="container py-5">
    <div class="row">
        ...
        <div class="col-lg-12 mb-4">
            <div class="card border-0 shadow-sm rounded-3" style="background: linear-gradient(135deg, #dd2222 0%, #fbb710 100%);">
                <div class="card-body text-white p-4">
                    <div class="row align-items-center">
                        <div class="col-md-8">
                            <h2 class="mb-2" style="font-weight: 600;">Welcome back, {{ Auth::user()->name }}!</h2>
                            <p class="mb-0" style="font-size: 14px; opacity: 0.9;">Email: {{ Auth::user()->email }}</p>
                            <p style="font-size: 14px; opacity: 0.9;">Member Since: {{ Auth::user()->created_at->format('M d, Y') }}</p>
                        </div>
    ...
    <div class="row g-3 mb-5">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-3 text-center h-100 profile-card hover-effect" style="transition: all 0.3s ease;">
                <div class="card-body p-4">
                    <div class="mb-3">
                        <i class="fa fa-heart fa-3x" style="color: #dd2222;"></i>
                    </div>
                    <h5 class="card-title mb-2">Wishlist</h5>
                    <p class="card-text text-muted small mb-3">View and manage your favorite items</p>
                    <a href="{{ route('profile.wishlist') }}" class="btn btn-outline-danger btn-sm rounded-pill">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-3 text-center h-100 profile-card hover-effect" style="transition: all 0.3s ease;">
                <div class="card-body p-4">
                    <div class="mb-3">
                        <i class="fa fa-shopping-cart fa-3x" style="color: #dd2222;"></i>
                    </div>
                    <h5 class="card-title mb-2">Shopping Cart</h5>
                    <p class="card-text text-muted small mb-3">Review and update your cart items</p>
                    <a href="{{ route('profile.cart') }}" class="btn btn-outline-danger btn-sm rounded-pill">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-3 text-center h-100 profile-card hover-effect" style="transition: all 0.3s ease;">
                <div class="card-body p-4">
                    <div class="mb-3">
                        <i class="fa fa-credit-card fa-3x" style="color: #dd2222;"></i>
                    </div>
                    <h5 class="card-title mb-2">Checkout</h5>
                    <p class="card-text text-muted small mb-3">Proceed to complete your purchase</p>
                    <a href="{{ route('profile.checkout') }}" class="btn btn-outline-danger btn-sm rounded-pill">
        ...
        <div class="col-lg-3 col-md-6">
            <div class="card border-0 shadow-sm rounded-3 text-center h-100 profile-card hover-effect" style="transition: all 0.3s ease;">
                <div class="card-body p-4">
                    <div class="mb-3">
                        <i class="fa fa-history fa-3x" style="color: #dd2222;"></i>
                    </div>
                    <h5 class="card-title mb-2">Order History</h5>
                    <p class="card-text text-muted small mb-3">Track and view your previous orders</p>
                    <a href="{{ route('profile.orders') }}" class="btn btn-outline-danger btn-sm rounded-pill">
    ...
    <div class="row g-3">
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div class="card-body">
                    <p class="text-muted small mb-3">Manage your delivery addresses</p>
                    <a href="{{ route('profile.addresses') }}" class="btn btn-sm btn-outline-danger rounded-pill">
        ...
        <div class="col-lg-6">
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div class="card-body">
                    <p class="text-muted small mb-3">Update password and security settings</p>
                    <a href="{{ route('profile.settings') }}" class="btn btn-sm btn-outline-danger rounded-pill">
