...
<div class="container py-5">
    <div class="row">
        <div class="col-lg-12">
            <a href="{{ route('profile.orders') }}" class="btn btn-outline-danger btn-sm rounded-pill mb-3">
            ...
            <div class="card border-0 shadow-sm rounded-3">
                ...
                <div class="card-body p-4">
                    <div class="row mb-4">
                        <div class="col-md-6">
                            <h6 style="color: #dd2222; font-weight: 600;">Order Information</h6>
                        ...
                        <div class="col-md-6">
                            <h6 style="color: #dd2222; font-weight: 600;">Shipping Address</h6>
                    ...
                    <h6 style="color: #dd2222; font-weight: 600; margin-bottom: 15px;">Order Items</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="d-flex justify-content-between" style="font-weight: 600; color: #dd2222; font-size: 16px;">
                                <span>Total:</span>
                                <span>$0.00</span>
                            </div>
                        </div>
