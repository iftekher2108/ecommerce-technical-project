            ...
            <div class="card border-0 shadow-sm rounded-3 mb-4">
                ...
                <div class="card-body p-4">
                    <form action="{{ route('checkout.process') }}" method="POST">
                        ...
                        <h6 class="mb-3" style="color: #dd2222; font-weight: 600;">Delivery Address</h6>
                        <div class="mb-3">
                        ...
                        <h6 class="mb-3" style="color: #dd2222; font-weight: 600;">Payment Method</h6>
                        <div class="mb-3">
        ...
        <div class="col-lg-4">
            <div class="card border-0 shadow-sm rounded-3">
                <div class="card-header bg-light rounded-top-3">
                    <h6 class="mb-0" style="color: #dd2222; font-weight: 600;">Order Summary</h6>
                </div>
                <div class="card-body p-4">
                    ...
                    <hr>
                    <div class="d-flex justify-content-between" style="font-weight: 600; color: #dd2222;">
                        <span>Total:</span>
                        <span>$0.00</span>
                    </div>
                </div>
